...
type TransportParameters struct {
	...
	// add a name to the params when running handshake
	// TODO: For implementing this feature, we need to convert the string to varint uint64, and then Marshal it
	SeminarDataName string
}
