...
const MaxCongestionWindowPackets = 500000
...
// MOC: the default value is (1 << 10) * 512 (512kb), now change to 512Mb
...
// The sendWindow of one connection will be updated from 0 to DefaultInitialMaxData in the handshake process
...
// MOC: always full when value is 256
const MaxConnUnprocessedPackets = 512
...
// MOC: double 5s to 10s
const RetiredConnectionIDDeleteTimeout = 100 * time.Second
