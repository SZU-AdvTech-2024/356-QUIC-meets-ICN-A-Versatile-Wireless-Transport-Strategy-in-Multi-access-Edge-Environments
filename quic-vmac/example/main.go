...
func setupHandler(www string) http.Handler {
	...
	mux.HandleFunc("/demo/png", func(w http.ResponseWriter, r *http.Request) {
		file, err := os.Open("3.png")
		if err != nil {
			panic(err)
		}
		defer file.Close()
	...
	mux.HandleFunc("/demo/flv", func(w http.ResponseWriter, r *http.Request) {
		quic.BigFileOrSmallFile(true)
		file, err := os.Open("2.flv")
		if err != nil {
			panic(err)
		}
		defer file.Close()
